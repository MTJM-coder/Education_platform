...
const content = [
  {
    ...
    subject: "Mathematics",
    detail: "45 min · Added today",
    icon: BookOpen,
    kind: "Lessons",
  },
  {
    type: "Video",
    title: "Understanding electric circuits",
    subject: "Physics",
    detail: "18 min · Added yesterday",
    icon: CirclePlay,
    kind: "Videos",
  },
  {
  ...
  },
  {
    ...
    subject: "Mathematics",
    detail: "10 questions · Due tomorrow",
    icon: ClipboardCheck,
    kind: "Quizzes",
  },
  {
          ...
          <section className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-sm text-gray-500">
                Continue learning at your own pace and track your
                progress.
              </p>
            </div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-3.5 py-2.5 text-sm font-medium text-pf-purple-dark transition hover:bg-gray-50"
            >
              <Library className="h-4 w-4 text-pf-purple" />
          ...
          <section className="mt-8 grid gap-5 xl:grid-cols-[1.55fr_0.8fr]">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Your latest lessons, activities and resources.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-48 rounded-lg border border-gray-200 py-2 pl-9 pr-3 text-xs outline-none transition focus:border-pf-purple focus:ring-2 focus:ring-pf-purple/10"
                    placeholder="Search..."
                  />
                </div>
              </div>
                ...
                {shownContent.map((item) => {
                  ...
                  return (
                    <button
                      key={item.title}
                      type="button"
                      className="flex w-full items-center gap-3 py-3.5 text-left transition hover:bg-[#FCFBFD]"
                    >
                ...
                {shownContent.length === 0 && (
                  <div className="py-10 text-center">
                    ...
                    <button
                      ...
                      className="mt-2 text-xs font-medium text-pf-purple hover:underline"
                    >
                      Clear filters
                    </button>
                  </div>
            ...
            <aside className="space-y-5">
              ...
              <section className="rounded-2xl bg-pf-purple p-5 text-white">
                ...
                <div className="mt-2 flex justify-between text-[10px] text-purple-200">
                  <span>M</span>
                  <span>T</span>
                  <span>W</span>
                  <span>T</span>
              ...
              <section className="rounded-2xl border border-gray-200 bg-white p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-gray-600">
                  Finish the mathematics lesson and attempt the
                  algebra quiz.
                </p>

                <div className="mt-4 flex items-center gap-3">
                  <div className="h-2 flex-1 overflow-hidden rounded-full bg-gray-100">
                    <div className="h-full w-1/2 rounded-full bg-pf-green" />
                  </div>
                ...
                <button
                  type="button"
                  className="mt-4 text-sm font-semibold text-pf-purple hover:underline"
                >
                  View daily plan →
                </button>
              </section>
...
function SubjectCard({ subject }) {
  const href = `/student-learning/${subject.name
    .toLowerCase()
    .replace(/\s+/g, "-")}`;

  return (
    <article className="rounded-2xl border border-gray-200 bg-white p-4 transition hover:-translate-y-0.5 hover:shadow-sm">
      <div className="flex items-start justify-between">
      ...
      <h3 className="mt-4 font-serif text-lg font-medium text-pf-purple-dark">
        {subject.name}
      </h3>
      ...
      <div className="mt-3 flex justify-between gap-2 text-[11px] text-gray-500">
        <span>
          {subject.done}/{subject.lessons} lessons
        </span>
      ...
      <a
        href={href}
        className="mt-4 flex w-full items-center justify-between border-t border-gray-100 pt-3 text-xs font-semibold text-pf-purple"
      >
        Open subject
...
function QuickLink({
  ...
  return (
    <a
      href={href}
      className="flex items-center justify-between rounded-lg border border-gray-100 px-3 py-2.5 transition hover:bg-pf-purple-light"
    >
      <div className="flex items-center gap-3">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gray-50 text-pf-purple">
